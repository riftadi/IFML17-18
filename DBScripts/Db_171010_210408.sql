...
alter table "public"."user"  add column  "comments_oid_comment"  int4;
alter table "public"."user"   add constraint fk_user_comments foreign key ("comments_oid_comment") references "public"."comments" ("oid_comment");
...
-- Creator [rel17]
alter table "public"."user"  add column  "collections_oid_collection"  int4;
alter table "public"."user"   add constraint fk_user_collections foreign key ("collections_oid_collection") references "public"."collections" ("oid_collection");
